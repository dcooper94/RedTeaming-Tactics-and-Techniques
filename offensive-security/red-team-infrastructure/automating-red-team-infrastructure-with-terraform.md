...
![[Screenshot from 2019-01-26 17-45-04.png]]
...
![[Screenshot from 2019-01-26 18-13-38.png]]
...
![[Screenshot from 2019-01-27 16-57-04.png]]

Additionally, `variables.tf` contains link to a password protected Cobalt Strike zip archive and the password itself:

![[Screenshot from 2019-01-29 22-32-07.png|URL to a password protected Cobalt Strike zip]]

![[Screenshot from 2019-01-27 17-01-52.png|variables.tf showing my fake and misspelled password]]
...
![[Screenshot from 2019-01-29 22-31-08.png]]
...
![[Screenshot from 2019-01-27 17-09-17.png]]
...
![[Screenshot from 2019-02-01 12-00-31.png|C2 redirector IPs]]

![[Screenshot from 2019-02-01 12-00-22.png|C2 teamserver IPs]]
...
![[Peek 2019-02-01 12-30.gif|Cobalt Strike C2 & C2 redirector test]]
...
![[Screenshot from 2019-02-01 12-41-44.png|Successful C2 traffic redirection]]
...
![[Screenshot from 2019-01-27 17-10-47.png]]
...
![[Screenshot from 2019-01-27 17-14-49.png]]
...
![[Screenshot from 2019-01-29 21-58-25.png]]
...
![[Screenshot from 2019-01-29 22-03-50.png]]
...
![[Screenshot from 2019-01-28 21-49-44.png]]
...
![[Screenshot from 2019-01-29 21-17-16.png]]

## Download & Try

If you would like to test this setup, feel free to grab the config files here:

[github.com/mantvydasb/Red-Team-Infrastructure-Automation](https://github.com/mantvydasb/Red-Team-Infrastructure-Automation)

## References

[bluescreenofjeff.com/2016-03-22-strengthen-your-phishing-with-apache-mod_rewrite-and-mobile-user-redirection](https://bluescreenofjeff.com/2016-03-22-strengthen-your-phishing-with-apache-mod_rewrite-and-mobile-user-redirection/)

[rastamouse.me/2017/08/automated-red-team-infrastructure-deployment-with-terraform-part-1](https://rastamouse.me/2017/08/automated-red-team-infrastructure-deployment-with-terraform-part-1/)
...
[developers.digitalocean.com/documentation/changelog/api-v2/new-size-slugs-for-droplet-plan-changes](https://developers.digitalocean.com/documentation/changelog/api-v2/new-size-slugs-for-droplet-plan-changes/)
