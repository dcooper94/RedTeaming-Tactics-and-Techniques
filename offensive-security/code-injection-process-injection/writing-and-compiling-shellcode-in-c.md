...
![[image (688).png|Assembly instructions are generated based on the c-shellcode.asm]]
...
![[image (680).png|Comment out both includelib directives]]
...
![[image (677).png|Add AlignRSP at the top of \_TEXT segment]]
...
![[pasting-executing-shellcode (1).gif|notepad.exe executing shellcode that pops a MessageBox as seen in xdbg64]]
