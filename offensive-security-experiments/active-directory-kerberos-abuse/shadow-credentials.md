...
tags: [#lateral-movement, #persistence]
---
...
![[image (1084).png|Everyone is allowed to write to SAC1$ computer account object]]
...
![[image (1089|Adding shadow credentials to sac1$ computer account]] (1) (1).png>)
...
![[image (1089|SAC1$ with shadow credential set in the attribute msDS-KeyCredentialLink]] (1).png>)
...
![[image (1088|Attempt to list c$ on the domain controller before shadow credentials attack - fail]] (1).png>)
...
![[image (1087|Attempt to list c$ on the domain controller after shadow credentials attack - success]] (1).png>)
...
![[image (1087).png|user-server2$ is over-permissioned and can be taken over by abusing Shadow Credentials]]
...
![[image (1086).png|TGT is retrieved for user-server2$]]
...
![[image (1085|Attempt to list c$ admin share fails]] (1).png>)
...
![[image (1090|Computer Account Takeover with shadow credentials is successful]] (1) (1).png>)
...
![[image (1090|S4U2Self - CIFS service requested TGS to itself on behalf of first\admin]] (1).png>)
...
[posts.specterops.io/shadow-credentials-abusing-key-trust-account-mapping-for-takeover-8ee1a53566ab](https://posts.specterops.io/shadow-credentials-abusing-key-trust-account-mapping-for-takeover-8ee1a53566ab)
